...
klass = ElementKlass.find_by(name: 'cell')
pp = {
  layers: {
    general_layer: {
      key: 'general_layer',
...
ElementKlass.create!(name: 'cell', label: 'cell lines', desc: 'cell lines', icon_name: 'fa fa-braille', klass_prefix: 'C', properties_template: pp) if klass.nil?