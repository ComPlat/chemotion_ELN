...
klass = ElementKlass.find_by(name: 'mof')
...
ElementKlass.create!(name: 'mof', label: 'MOF', desc: 'Metal Organic Framework', icon_name: 'fa fa-bullseye', klass_prefix: 'M', properties_template: pp) if klass.nil?
