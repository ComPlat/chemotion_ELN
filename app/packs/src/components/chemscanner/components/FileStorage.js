...
import FileItemTreeCellRenderer from './FileItemTreeCellRenderer';
...
export default class FileStorage extends React.Component {
  constructor(props) {
    ...
    this.columnDefs = [
      {
        ...
        cellRenderer: 'treeIconCellRenderer',
        cellRendererParams: {
    ...
    this.frameworkComponents = {
      treeIconCellRenderer: FileItemTreeCellRenderer
    };
  }
  ...
  render() {
    ...
    const treeData = buildTreeData(rowData);
