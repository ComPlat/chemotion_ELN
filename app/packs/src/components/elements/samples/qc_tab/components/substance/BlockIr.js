...
import QcMolView from 'src/components/elements/samples/qc_tab/components/helper/qc_mol_view';
import { iconByMargin } from 'src/components/elements/samples/qc_tab/components/helper/icon';
import { tableIr } from 'src/components/elements/samples/qc_tab/components/helper/ir';
