...
import LineScore from 'src/components/elements/samples/qc_tab/components/summary/LineScore';
import {
  LineTitle,
  LineQcp,
  LineQck,
  LineDav,
} from 'src/components/elements/samples/qc_tab/components/summary/LineSummary';
import { evalScore } from 'src/components/elements/samples/qc_tab/components/summary/eval';
