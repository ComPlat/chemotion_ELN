...
import ContainerRow from 'src/components/elements/samples/analysesTab/SampleDetailsContainersDnd';
import {
  HeaderDeleted,
  HeaderNormal,
  AnalysisModeBtn
} from 'src/components/elements/samples/analysesTab/SampleDetailsContainersAux';
