...
import LineScore from 'src/components/elements/samples/qcTab/components/summary/LineScore';
import {
  LineTitle,
  LineQcp,
  LineQck,
  LineDav,
} from 'src/components/elements/samples/qcTab/components/summary/LineSummary';
import { evalScore } from 'src/components/elements/samples/qcTab/components/summary/eval';
