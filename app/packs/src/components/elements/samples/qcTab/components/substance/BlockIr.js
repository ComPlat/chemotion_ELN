...
import QcMolView from 'src/components/elements/samples/qcTab/components/helper/QcMolView';
import { iconByMargin } from 'src/components/elements/samples/qcTab/components/helper/icon';
import { tableIr } from 'src/components/elements/samples/qcTab/components/helper/ir';
