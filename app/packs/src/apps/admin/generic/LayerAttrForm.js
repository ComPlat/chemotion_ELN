        ...
        <FormGroup controlId="formControlLayerKey">
          <InputGroup>
            ...
            <FormControl
              ...
              inputRef={(ref) => { this.lf_layerKey = ref; }}
              readOnly={!!layer.key}
            />
          </InputGroup>
          <div className="help">
            Layer name is unique in the template
            <br />
        ...
        <FormGroup controlId="formControlLayerPosition">
          <InputGroup>
            ...
            <FormControl
              ...
              inputRef={(ref) => { this.lf_position = ref; }}
              min={1}
            />
          </InputGroup>
        </FormGroup>
        <FormGroup controlId="formControlLayerColor">
          <InputGroup>
            ...
            <FormControl
              ...
              inputRef={(ref) => { this.lf_color = ref; }}
            >
        ...
        <FormGroup controlId="formCtlHeaderStyle">
          <InputGroup>
            ...
            <FormControl
              ...
              inputRef={(ref) => { this.lf_style = ref; }}
            >
