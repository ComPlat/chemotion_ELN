  ...
  const renderTypography = () => {
    return (
      <>
        ...
        <h5>Heading 5</h5>
        <h6>Heading 6</h6>
        <p>This is a paragraph. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas non commodo nisi. Vestibulum pretium tellus id fermentum sodales. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Curabitur venenatis libero ut quam aliquam dictum. Nullam at iaculis tellus. Curabitur et erat mollis, maximus sem et, pulvinar felis.</p>
        <ul>
        ...
        <p>This paragraph contains a <a href="https://chemotion.net/" targert="_blank">link</a> to another page.</p>
