...
import ReactionDetailsProperties from
  'src/apps/mydb/elements/details/reactions/propertiesTab/ReactionDetailsProperties';
  ...
  productData(reaction) {
    ...
    return (
      <Tabs
        ...
        onSelect={this.handleSelectActiveAnalysisTab}
      >
        {tabs}
