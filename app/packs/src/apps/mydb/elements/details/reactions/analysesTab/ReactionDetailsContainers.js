...
import { AnalysisVariationsRowAssociation } from 'src/apps/mydb/elements/details/reactions/variationsTab/ReactionVariationsAnalyses';
    ...
    return (
      <div className="upper-btn">
        ...
        <SpectraEditorButton
          ...
          hasNMRium={hasNMRium}
        />
        <AnalysisVariationsRowAssociation
          reaction={reaction}
          analysisID={container.id}
          onChange={this.props.parent.handleReactionChange}
          disabled={readOnly || container.isNew} // Disable on unsaved containers since variations rely on container IDs (which are preliminary prior to saving).
        />
      </div>
    );
  };
