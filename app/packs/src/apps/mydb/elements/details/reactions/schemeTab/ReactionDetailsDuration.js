        ...
        <Col md={3} sm={6}>
          <Form.Group>
            ...
            <InputGroup>
              ...
              />
              <Button disabled={!permitOn(reaction)} variant='secondary' active onClick={() => this.setCurrentTime('timestampStart')}>
        ...
        <Col md={3} sm={6}>
          <Form.Group>
            ...
            <InputGroup>
              ...
              />
              <Button disabled={!permitOn(reaction)} variant='secondary' active onClick={() => this.setCurrentTime('timestampStop')}>
                <i className="fa fa-clock-o" aria-hidden="true" />
              </Button>
            </InputGroup>
          </Form.Group>
        ...
        <Col md={3} sm={6}>
          <Form.Group>
            ...
            <InputGroup>
              ...
              >
                <Button disabled={!permitOn(reaction)} active variant='secondary' data-clipboard-text={durationCalc || ' '}>
              ...
              >
                <Button disabled={!permitOn(reaction)} active variant='secondary' onClick={() => this.copyToDuration()}>
