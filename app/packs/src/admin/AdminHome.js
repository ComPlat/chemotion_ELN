...
import GroupsDevices from 'src/admin/GroupsDevices';
import MessagePublish from 'src/admin/MessagePublish';
import DataCollector from 'src/admin/DataCollector';
import OlsTerms from 'src/admin/OlsTerms';
import NovncSettings from 'src/admin/NovncSettings';
import MatrixManagement from 'src/admin/MatrixManagement';
import TextTemplateContainer from 'src/admin/text_templates/TextTemplateContainer';
import GenericElementAdmin from 'src/admin/GenericElementAdmin';
import SegmentElementAdmin from 'src/admin/SegmentElementAdmin';
import DatasetElementAdmin from 'src/admin/DatasetElementAdmin';
import DelayedJobs from 'src/admin/DelayedJobs';
import TemplateManagement from 'src/admin/TemplateManagement';
import ConverterAdmin from 'src/admin/converter/AdminApp';
