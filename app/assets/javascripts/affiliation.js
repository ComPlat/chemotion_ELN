document.querySelectorAll('.affiliation-line').forEach((box) => {
  let delButton = box.querySelector('td > a.del-affiliation'),
      ...
      fromCell = box.querySelector('.affiliation_from'), toCell = box.querySelector('.affiliation_to'),
  ...
  delButton.addEventListener('click', (e) => {
      ...
      const span = delButton.querySelector('span');
  ...
  fromCell.addEventListener('mouseleave', (e) => {
    const val = fromCell.querySelector('input').value;
  ...
  toCell.addEventListener('mouseleave', (e) => {
    const val = toCell.querySelector('input').value;
