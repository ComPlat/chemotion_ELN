export const reagents_kombi = {
  ...
  "[1,1'-Bis(diphenylphosphino)ferrocene]palladium(II) dichloride, PdCl2(dppf), Pd(dppf)Cl2": 'c1ccc(cc1)P(c1ccccc1)C1=CC=C[CH-]1.c1ccc(cc1)P(c1ccccc1)C1=CC=C[CH-]1.Cl[Pd]Cl.[Fe+2]',
  "[1,1′-Bis(diphenylphosphino)ferrocene]dichloropalladium(II), complex with dichloromethane, PdCl2(dppf)": 'c1ccc(cc1)P(c1ccccc1)C1=CC=C[CH-]1.c1ccc(cc1)P(c1ccccc1)C1=CC=C[CH-]1.ClCCl.Cl[Pd]Cl.[Fe+2]',
  ...
  "[1,1′-Bis(diphenylphosphino)ferrocene]dichloropalladium(II), PdCl2(dppf)": 'C1=CC=C(C=C1)P(C2=CC=CC=C2)[C]3[CH][CH][CH][CH]3.C1=CC=C(C=C1)P(C2=CC=CC=C2)[C]3[CH][CH][CH][CH]3.Cl[Pd]Cl.[Fe]',
  ...
  "Bis(dibenzylideneacetone)palladium(0), Pd(dba)2": 'O=C(/C=C/C1=CC=CC=C1)/C=C/C2=CC=CC=C2.O=C(/C=C/C3=CC=CC=C3)/C=C/C4=CC=CC=C4.[Pd]',
  ...
  "Bis(pinacolato)diboron, BPin": 'B1(OC(C(O1)(C)C)(C)C)B2OC(C(O2)(C)C)(C)C',
  ...
  "Di-tert-butyl Peroxide, DTBP": 'CC(OOC(C)(C)C)(C)C',
  ...
  "Hydriodic Acid, HI": '[H]I',
  "Hydrochloric Acid, HCl": '[H]Cl',
  "Hydrogen Bromide": '[H]Br',
  "Hydrogen Chloride": '[H]Cl',
  "Hydrogen peroxide, H2O2": '[H]OO[H]',
  ...
  "Lead Tetraacetate , Pb(OAc)4": 'CC([O-])=O.CC([O-])=O.CC([O-])=O.CC([O-])=O.[Pb+4]',
  ...
  "Lithium Borohydride, LiBH4": '[Li+].[BH4-]',
  "lithium bromid, LiBr": '[Li+].[Br-]',
  ...
  "Lithium methoxide, LiOMe": 'C[O-].[Li+]',
  "Lithium peroxide": '[O-][O-].[Li+].[Li+]',
  "lithium tetrafluoroborate, LiBF4": 'F[B-](F)(F)F.[Li+]',
  ...
  "magnesium bromide, MgBr2": '[Mg+2].[Br-].[Br-]',
  "magnesium carbonate, MgCO3": '[O-]C([O-])=O.[Mg+2]',
  "magnesium chloride, MgCl2": '[Mg+2].[Cl-].[Cl-]',
  "Magnesium di-tert-butoxide": 'CC(C)([O-])C.CC(C)([O-])C.[Mg+2]',
  "Magnesium ethoxide, Mg(OEt)2": 'CC[O-].CC[O-].[Mg+2]',
  "MAGNESIUM HYDROXIDE, Mg(OH)2": '[Mg+2].[OH-].[OH-]',
  "magnesium iodide, MgI2": '[Mg+2].[I-].[I-]',
  "Magnesium methoxide, Mg(OMe)2": 'C[O-].C[O-].[Mg+2]',
  "magnesium permanganate, Mg(MnO4)2": 'O=[Mn](=O)([O-])=O.O=[Mn](=O)([O-])=O.[Mg+2]',
  "Magnesium permanganate hydrate": 'O=[Mn](=O)([O-])=O.O=[Mn](=O)([O-])=O.[H]O[H].[Mg+2]',
  "Magnesium peroxide": '[O-][O-].[Mg+2]',
  "magnesium sulfate, MgSO4": 'O=S([O-])([O-])=O.[Mg+2]',
  ...
  "manganese sulfate, MnSO4": 'O=S([O-])([O-])=O.[Mn+2]',
  ...
  "Methylmagnesium Bromide, MeMgBr": 'Br[Mg]C',
  "Methylmagnesium chloride, MeMgCl": 'Cl[Mg]C',
  "Methylmagnesium Iodide, MeMgI": 'I[Mg]C',
  ...
  "N-Bromosuccinimide, NBS": 'O=C(N1Br)CCC1=O',
  "n-Butanol": 'CCCCO',
  "n-Butyllithium solution, BuLi": '[Li]CCCC',
  ...
  "N-Chlorosuccinimide, NCS": 'O=C(N1Cl)CCC1=O',
  "Neodymium": '[Nd]',
  ...
  "Nitric acid, HNO3": 'O[N+]([O-])=O',
  "Nitrilotriacetic Acid": 'O=C(O)CN(CC(O)=O)CC(O)=O',
  "nitromethane, MeNO2": 'C[N+]([O-])=O',
  ...
  "Osmium": '[Os]',
  "Osmium Tetroxide, OsO4": '[Os+8].[O-2].[O-2].[O-2].[O-2]',
  ...
  "Oxygen, O2": 'OO',
  "Ozone, O3": 'O=[O+][O-]',
  "Palladium Carbon , Pd-C, PdC, Pd/C": '[Pd]',
  "Palladium hydroxide, Pd(OH)2": '[Pd+2].[OH-].[OH-]',
  "Palladium(II) Acetate, Pd(OAc)2": 'CC([O-])=O.CC([O-])=O.[Pd+2]',
  "Palladium(II) Chloride, PdCl2": '[Pd+2].[Cl-].[Cl-]',
  ...
  "potassium acetate, KOAc": 'CC([O-])=O.[K+]',
  ...
  "Potassium Borohydride, KBH4": '[K+].[BH4-]',
  "Potassium butanolate": 'CC([O-])(C)C.[K+]',
  "potassium carbonate, K2CO3": '[O-]C([O-])=O.[K+].[K+]',
  "potassium chloride, KCl": '[K+].[Cl-]',
  "Potassium cyanide, KCN": '[C-]#N.[K+]',
  ...
  "Ruthenium": '[Ru]',
  "Ruthenium(III) Chloride, RuCl3": '[Ru+3].[Cl-].[Cl-].[Cl-]',
  ...
  "Sodium amide, NaNH2": '[Na+].[NH2-]',
  "Sodium ascorbate": '[O-]C([C@H](O1)[C@H](CO)O)=C(O)C1=O.[Na+]',
  "sodium azide, NaN3": '[N-]=[N+]=[N-].[Na+]',
  ...
  "Sodium Borohydride, NaBH4": '[Na+].[BH4-]',
  "sodium bromate": 'O=Br([O-])=O.[Na+]',
  "sodium bromide, NaBr": '[Na+].[Br-]',
  "Sodium Bromodifluoroacetate": 'O=C([O-])C(F)(Br)F.[Na+]',
  "sodium carbonate, Na2CO3": '[O-]C([O-])=O.[Na+].[Na+]',
  ...
  "tert-Butyllithium, tBuLi": '[Li]C(C)(C)C',
  ...
  "Tetrakis(triphenylphosphine)palladium(0), Tetrakis, Pd(Ph3)4": 'P(C1=CC=CC=C1)(C2=CC=CC=C2)C3=CC=CC=C3.P(C4=CC=CC=C4)(C5=CC=CC=C5)C6=CC=CC=C6.P(C7=CC=CC=C7)(C8=CC=CC=C8)C9=CC=CC=C9.P(C%10=CC=CC=C%10)(C%11=CC=CC=C%11)C%12=CC=CC=C%12.[Pd]',
  ...
  "Tetramethylsilane, TMS": 'C[Si](C)(C)C',
  ...
  "Triethylsilane, TES": 'CC[SiH](CC)CC',
  ...
  "Trifluoroacetic Acid, TFA": 'O=C(O)C(F)(F)F',
  "Trifluoroacetic Anhydride, TFAA": 'O=C(OC(C(F)(F)F)=O)C(F)(F)F',
  ...
  "Trimethylsilyl Chloride, TMSCl, TMS-chloride": 'C[Si](C)(Cl)C',
  "Trimethylsilyl Azide, TMS-Azide, TMSA, TMSN3": 'C[Si](C)(N=[N+]=[N-])C',
  ...
  "Tris(dibenzylideneacetone)dipalladium(0), Pd2(dba)3": 'O=C(/C=C/C1=CC=CC=C1)/C=C/C2=CC=CC=C2.O=C(/C=C/C3=CC=CC=C3)/C=C/C4=CC=CC=C4.O=C(/C=C/C5=CC=CC=C5)/C=C/C6=CC=CC=C6.[Pd].[Pd]',
