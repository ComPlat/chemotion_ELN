...
module Tagging
  ...
  def update_tag
    ...
    when 'Labimotion::ElementsSample'
      ...
      element = 'sample'
    when 'CollectionsReaction', 'CollectionsWellplate', 'CollectionsSample', 'Labimotion::CollectionsElement', 'CollectionsScreen', 'CollectionsResearchPlan', 'CollectionsVessel'
