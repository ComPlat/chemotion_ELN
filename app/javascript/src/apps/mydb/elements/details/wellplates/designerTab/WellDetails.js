...
const colorPicker = (well, onChange, activeColor, setActiveColor) => {
  const dynamicStyle = `
    .custom-circle-picker .circle-picker span div {
      border: 2px solid transparent;
    }
    .custom-circle-picker .circle-picker span div[style*="background: ${activeColor}"] {
  ...
  return (
    <div className="mt-3">
      ...
      <Form.Group controlId="formHorizontalPicker" className="my-3">
        <div className="custom-circle-picker">
          {/* Add circle-picker class here */}
          <div className="circle-picker">
            <CirclePicker
              ...
              onChangeComplete={(color) => {
                const newColor = color.hex === well.color_code ? null : color.hex;
                well.color_code = newColor;
                console.log("well.color_code", well.color_code);
