                    ...
                    (element) => (
                      <div
                        ...
                        className={cs(
                          'element-group-item',
                          {
                            'element-group-item--selected': isElementSelected(element),
                          },
                        )}
                      >
                        <div className="element-group-item-checkbox">
                          <ElementCheckbox element={element} />
                        </div>
                        <div className="element-group-item-content">
                          {renderGroupItem(element, () => showDetails(element))}
                        </div>
                        <div className="element-group-item-drag-handle">
