    ...
    this.state = {
      columns: {
        sample: [
          ...
          { value: 'diameter', text: 'Diameter', checked: false },
          ...
          { value: 'cspi', text: 'CSPI', checked: false },
          { value: 'particle_size', text: 'Particle size', checked: false },
          { value: 'shape', text: 'Shape', checked: false },
          { value: 'sieve_fraction', text: 'Sieve fraction', checked: false },
        ],
        molecule: [
