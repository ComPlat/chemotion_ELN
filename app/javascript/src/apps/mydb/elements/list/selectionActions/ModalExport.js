    ...
    this.state = {
      columns: {
        sample: [
          ...
          { value: ['height', 'height_unit'], text: 'Height', checked: false },
          { value: ['width', 'width_unit'], text: 'Width', checked: false },
          { value: ['length', 'length_unit'], text: 'Length', checked: false },
          { value: ['diameter', 'diameter_unit'], text: 'Diameter', checked: false },
          ...
          { value: 'material', text: 'Material', checked: false },
          { value: ['cspi', 'cspi_unit'], text: 'CSPI', checked: false },
