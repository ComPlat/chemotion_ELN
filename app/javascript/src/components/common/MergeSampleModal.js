...
export default function MergeSampleModal({
  ...
  const sourceLabel = sourceProduct?.short_label || 'Source';
  const targetLabel = targetProduct?.short_label || 'Target';
  ...
  return (
    ...
    >
      ...
      <ul className="mb-0">
        ...
        <li>
          <strong>{sourceLabel}</strong>
          {' will be marked as Legacy and removed from the products list.'}
        </li>
      </ul>
    </AppModal>
  );
