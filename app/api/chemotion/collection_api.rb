      ...
      namespace :elements do
        ...
        put do
          ...
          API::ELEMENTS.each do |element|
            ...
            next unless ui_state.present?

            ids = API::ELEMENT_CLASS[element].by_collection_id(from_collection_id).by_ui_state(ui_state).pluck(:id)
            next if ids.empty?
        ...
        post do
          ...
          API::ELEMENTS.each do |element|
            ...
            collections_element_class = API::ELEMENT_CLASS[element].collections_element_class
            collections_element_class.create_in_collection(ids, from_collection.id, to_collection_id)
          end
