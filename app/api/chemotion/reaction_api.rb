...
module ReactionHelpers
  ...
  def create_sub_sample(sample, current_user, reaction, fixed_label)
  ...
  def create_new_sample(sample, current_user, reaction, fixed_label)
  ...
  def associate_sample_with_reaction(sample, modified_sample, reaction, material_group)
  ...
  def destroy_unused_samples(reaction, modified_sample_ids)
        ...
        samples.each_with_index do |sample, idx|
          ...
          if sample.is_new
            if sample.parent_id && material_group != 'product'
              modified_sample = create_sub_sample(sample, current_user, reaction, fixed_label)
            else
              modified_sample = create_new_sample(sample, current_user, reaction, fixed_label)
            end
          else
          ...
          associate_sample_with_reaction(sample, modified_sample, reaction, material_group)
        end
      end
      destroy_unused_samples(reaction, modified_sample_ids)
    end
    reaction.reload
