  ...
  EXP_MAP_ATTR =
    # commented out lines are blacklisted attributes
    {
      sample: {
        ...
        particle_size: ["COALESCE(s.particle_size, s.sample_details->>'particle_size', s.xref->>'particle_size')", '"particle size"', 0],
        ...
        sieve_fraction: ["COALESCE(s.sieve_fraction, s.sample_details->>'sieve_fraction', s.xref->>'sieve_fraction')", '"sieve fraction"', 0],
        sieve_fraction_unit: ["s.sample_details->>'sieve_fraction_unit'", '"sieve fraction unit"', 0],
        layer_thickness: ["COALESCE(s.layer_thickness, s.sample_details->>'layer_thickness', s.xref->>'layer_thickness')", '"layer thickness"', 0],
        layer_thickness_unit: ["s.sample_details->>'layer_thickness_unit'", '"layer thickness unit"', 0],
        liquid_medium: ["COALESCE(s.liquid_medium, s.sample_details->>'liquid_medium', s.xref->>'liquid_medium')", '"liquid medium"', 0],
        stabilizer: ["COALESCE(s.stabilizer, s.sample_details->>'stabilizer', s.xref->>'stabilizer')", '"stabilizer"', 0],
