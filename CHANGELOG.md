...
### Features and enhancements
  ...
  * Reaction variations
    * analyses  ([#1870](https://github.com/ComPlat/chemotion_ELN/pull/1870)) [:books: docs](https://chemotion.net/docs/eln/ui/details?_highlight=reaction&#variations-tab)
  ...
  * Barcode Datamatrix printing configuration: [:books: docs](https://chemotion.net/docs/eln/install_configure/configuration?_highlight=datama#configuring-pdf-layouts-for-qr-codes-barcode-and-datamatrix-stickers)
  ...
  * Gas phase reaction scheme  ([#1933](https://github.com/ComPlat/chemotion_ELN/pull/1933)) [:books: docs](https://chemotion.net/docs/eln/ui/elements/reactions?_highlight=gas#gas-phase-reaction-scheme)
...
#### ChemSpectra and NMRIUM
  ...
  * update chemspectra-app to handle GC layout  ([#2039](https:/https://github.com/ComPlat/chemotion_saurus/tree/main/docs/services/chemspectra/github.com/ComPlat/chemotion_ELN/pull/2039))
