...
RSpec.describe Screen, type: :model do
  ...
  describe 'deletion' do
    ...
    it 'only soft deletes screen and associated wellplates' do
      expect(sc2.deleted_at).to_not be_nil
      expect(sc2.screens_wellplates.only_deleted).to_not be_empty
      expect(sc2.wellplates.only_deleted).to eq []
      expect(sc2.collections_screens.only_deleted).to_not be_empty
