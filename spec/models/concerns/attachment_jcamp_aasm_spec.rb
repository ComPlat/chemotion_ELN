...
RSpec.describe AttachmentJcampAasm do
  ...
  describe 'split file name into parts' do
    ...
    context 'file name has 1 part' do
      before do
    ...
    context 'file name has 2 parts' do
      before do
    ...
    context 'file name has 3 parts' do
      before do
  ...
  describe 'get file extension' do
    ...
    context 'file name is empty' do
      ...
      it 'extension parts are nil' do
        extension_parts = att_jcamp_aasm.extension_parts
        expect(extension_parts[0]).to eq(nil)
        expect(extension_parts[1]).to eq(nil)
      end
    end
