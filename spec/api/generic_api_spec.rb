...
describe 'GenericAPI' do
  ...
  context 'with authorized user logged in' do
    ...
    describe 'Create Generic Element' do
      before do
        post '/api/v1/generic_elements',
             params: { element_klass: ek, name: 'Name of new element', container: { id: c1.id, attachments: [], children: c1.children, is_new: false, is_deleted: false, name: 'container' }, properties: el_pop }, as: :json
      end
    ...
    describe 'Update Generic Element' do
      before do
        put "/api/v1/generic_elements/#{el.id}",
            params: { id: el.id, name: 'New Name', container: { id: c1.id, attachments: [], children: c1.children, is_new: false, is_deleted: false, name: 'container' }, properties: el_pop }, as: :json
      end
    ...
    describe 'Update Generic Element Template' do
      before do
        post '/api/v1/generic_elements/update_template',
             params: { klass: 'ElementKlass', id: ek.id, properties_template: el_pop.to_h }, as: :json
      end
    ...
    describe 'Update Generic Segment Template' do
      before do
        post '/api/v1/generic_elements/update_template',
             params: { klass: 'SegmentKlass', id: sk.id, properties_template: el_pop.to_h }, as: :json
      end
    ...
    describe 'Update Generic Dataset Template' do
      before do
        post '/api/v1/generic_elements/update_template',
             params: { klass: 'DatasetKlass', id: dk.id, properties_template: el_pop.to_h }, as: :json
      end
  ...
  context 'with unauthorized user logged in' do
    ...
    describe 'Update Generic Segment Template' do
      before do
        post '/api/v1/generic_elements/update_template',
             params: { klass: 'SegmentKlass', id: ek.id, properties_template: el_pop.to_h }, as: :json
      end
    ...
    describe 'Update Generic Dataset Template' do
      before do
        post '/api/v1/generic_elements/update_template',
             params: { klass: 'DatasetKlass', id: ek.id, properties_template: el_pop.to_h }, as: :json
      end
