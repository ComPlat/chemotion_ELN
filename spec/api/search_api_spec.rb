...
#     let(:sample_a) { create(:sample, name: 'SampleA', creator: current_user) }
#     let(:sample_b) { create(:sample, name: 'SampleB', creator: current_user) }
...
#     let(:reaction) { create(:reaction, name: 'Reaction', samples: [sample_a, sample_b], creator: current_user) }
