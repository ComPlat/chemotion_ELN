...
describe('NumericInputUnit component', () => {
  it('renders correctly', () => {
    ...
    const expectedHtml = '<div class="numericInputWithUnit_g"><label class="form-label">Amount</label><div class="input-group"><input type="text" value="1" name="chemical_amount_in_g" label="Amount" class="px-1 form-control"/><button type="button" class="btn active btn-primary">g</button></div></div>';
