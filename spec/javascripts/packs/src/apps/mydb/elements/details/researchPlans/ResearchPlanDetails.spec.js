...
describe('ResearchPlanDetails', async () => {
  ...
  describe('.handleBodyChange', async () => {
    describe('on non existing field', async () => {
    ...
    describe('on non image field', async () => {
    ...
    describe('replacing an image field for the first time', async () => {
    ...
    describe(
      ...
      async () => {
        it('expecting to be replaced with old value in memory', async () => {
          const researchPlanWithImage = await ResearchPlanFactory.build('with_image_body_field', {}, { reset: true });
          const attachmentToAdd = await AttachmentFactory.build('new');

          researchPlanWithImage.attachments[0].file = [];
          researchPlanWithImage.attachments[0].file.preview = researchPlanWithImage.attachments[0].identifier;
