...
describe('Reaction', () => {
  ...
  describe('Reaction.buildEmpty()', () => {
    ...
    it('should initialize use_reaction_volume_for_concentration as false', () => {
      const emptyReaction = Reaction.buildEmpty(1);
      expect(emptyReaction.use_reaction_volume_for_concentration).toBe(false);
    });
  });
  ...
  describe('Reaction.serialize()', () => {
    ...
    it('should include use_reaction_volume_for_concentration in serialized output', () => {
      reaction.use_reaction_volume_for_concentration = true;
      const serialized = reaction.serialize();
      expect(serialized.use_reaction_volume_for_concentration).toBe(true);
    });
  });
  ...
  describe('Reaction.updateAllConcentrations()', () => {
    it('calls updateConcentrationFromSolvent for all materials', async() => {
      ...
      reaction.volume = 0.5;
      reaction.use_reaction_volume_for_concentration = false;
