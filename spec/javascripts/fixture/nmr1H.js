const nmrData1H = {
  ...
  2463: {
    formula: 'C12H20OS2',
    content: { ops: [{ insert: "1",attributes: { script: "super"} }, { insert: "H NMR (500 MHz, CDCl" }, { insert: "3",attributes: { script: "sub"} }, { insert: ", ppm) δ = 0.95–1.02 (m, 9H), 2.05–2.14 (m, 2H), 2.34–2.40 (m, 3H), 2.49 (dd, " }, { insert: "J ",attributes: { italic: true} }, { insert: "= 15.6 Hz, " }, { insert: "J ",attributes: { italic: true} }, { insert: "= 5.9 Hz, 1H), 3.03–3.12 (m, 1H), 3.25–3.29 (m, 4H).\n\n"}]},
    expected: '',
  },
  2464: {
    formula: 'C13H22OS2',
