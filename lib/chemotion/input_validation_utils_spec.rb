...
require_relative '../../../lib/chemotion/input_validation_utils'
...
RSpec.describe Chemotion::InputValidationUtils do
  describe '.valid_vendor_name?' do
    ...
    context 'with invalid vendor names' do
      ...
      it 'rejects vendor names that are too short' do
        ...
        expect(described_class.valid_vendor_name?('ab')).to be false
      end
  ...
  describe '.safe_word?' do
    ...
    it 'blocks dangerous/reserved words' do
      aggregate_failures do
        expect(described_class.safe_word?('admin')).to be false
        expect(described_class.safe_word?('root')).to be false
        expect(described_class.safe_word?('test')).to be false
        expect(described_class.safe_word?('null')).to be false
        expect(described_class.safe_word?('undefined')).to be false
        expect(described_class.safe_word?('script')).to be false
        expect(described_class.safe_word?('javascript')).to be false
        expect(described_class.safe_word?('sql')).to be false
        expect(described_class.safe_word?('drop')).to be false
        expect(described_class.safe_word?('delete')).to be false
        expect(described_class.safe_word?('insert')).to be false
        expect(described_class.safe_word?('update')).to be false
        expect(described_class.safe_word?('select')).to be false
      end
    end
  end
