...
#   the MOF (MOFid/MOFkey) service
#
# Modelled on config/initializers/indigo_service.rb. If config/mof_service.yml
# is missing or invalid the service is left disabled (see config/default_missing.yml).
